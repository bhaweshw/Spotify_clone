...
function NavButtons() {
    ...
    const [showTool4,setShowTool4] = useState(false)
    const [delayed4, setDelayed4] = useState(false)

    const [showTool5,setShowTool5] = useState(false)
    const [delayed5, setDelayed5] = useState(false)
